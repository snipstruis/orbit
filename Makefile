#############################################################################
# Makefile for building: orbit
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  orbit.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile orbit.pro
#############################################################################
...
Makefile: orbit.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		orbit.pro
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile orbit.pro
...
dist: 
	@test -d .tmp/orbit1.0.0 || mkdir -p .tmp/orbit1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/orbit1.0.0/ && (cd `dirname .tmp/orbit1.0.0` && $(TAR) orbit1.0.0.tar orbit1.0.0 && $(COMPRESS) orbit1.0.0.tar) && $(MOVE) `dirname .tmp/orbit1.0.0`/orbit1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/orbit1.0.0
